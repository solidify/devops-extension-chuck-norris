After installing the Chuck Norris build enhancer you just have to add the Chuck Norris build task to the build defintion where you want the Chuck Norris quotes to appear.
